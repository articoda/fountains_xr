...
from auxi.plots import (
    ...
    smooth_accessibility_share_for_plot
)
...
# Define the folder containing fountain data.
...
# Define the folder containing raster data.
...
def main(analysis_level, region_name=None, town_name=None):
    ...
    accessibility_share_250m_plot = smooth_accessibility_share_for_plot(
        accessible_population_agg=accessible_population_agg,
        total_population_agg=total_population_agg,
        sigma=1.0,
        min_total_population=min_total_population
    )
    ...
    plot_accessibility_share_raster(
        accessibility_share=accessibility_share_250m_plot,
